            ...
            <div style="margin-left:15%;margin-top:5%">
                ...
                <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-position="right" label-width="90px">
                    <el-form-item label="昵称：">
                        <el-input type="text" v-model="ruleForm.name" auto-complete="off" style="width:50%"
                                  clearable></el-input>
                    </el-form-item>
                    <el-form-item label="个人简介：">
                        <el-input type="textarea" v-model="ruleForm.desc" rows="5" style="width:50%"
                                  id="descAlert"></el-input>
                    </el-form-item>
            ...
            <div style="margin-left:15%;margin-top:5%">
                <el-form ref="ruleForm2" :model="ruleForm2" :rules="rules2" label-width="90px">
                    <el-form-item label="原密码：" prop="opass">
                        <el-input type="password" v-model="ruleForm2.opass" auto-complete="off" style="width:50%"
                                  clearable></el-input>
                    </el-form-item>
                    <el-form-item label="密码：" prop="pass">
                        <el-input type="password" v-model="ruleForm2.pass" auto-complete="off" style="width:50%"
                                  clearable></el-input>
                    </el-form-item>
                    <el-form-item label="确认密码：" prop="checkPass">
                        <el-input type="password" v-model="ruleForm2.checkPass" auto-complete="off" style="width:50%"
                                  clearable></el-input>
                    </el-form-item>
                    <el-form-item>
...
<script>
    export default {
            ...
            addCollection: function (formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        this.axios.get("http://localhost:6001/api/Users/Login?Email=" + this.$store.state.currentUserId +
                            "&Password=" +
                            this.ruleForm2.opass
                        )
                            .then((response) => {
                                if (response.data != 'Error' || esponse.data != 'NotFound') {
                                    this.axios.put('http://localhost:6001/api/Users/ChangePassword?email=' + this.$store.state.currentUserId +
        ...
        created() {
            ...
            console.log("this.ruleForm.name :" + this.$store.state.currentUsername)
            this.ruleForm.desc = this.$store.state.currentUserBio;
            console.log("this.ruleForm.desc " + this.$store.state.currentUsername)
            window.scroll(0, 0);
        }
    }
</script>
