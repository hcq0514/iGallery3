<template>
    <el-container>
            ...
            <el-col class="fixed">
              ...
              '&type=2'+'&Rand=' + Math.random()" alt="头像" @click="jumpToUser($store.state.currentUserId)"/>
                        ...
                        <el-col style="margin-left:-70%;width:50%;overflow:hidden">
                            ...
                            <el-row>
                                <div style="font-size:14px; color:#999999" class="self-intro">
                        ...
                        <el-row v-if="followUsers!=undefined && followUsers.length>0" :key="index"
                            ...
                            <el-col>
                                <div class="user-img border">
                                    <img class="user-img img-border hover-cursor"
                                         :src="followUser.photoUrl+'&Rand=' + Math.random()" alt="头像"
                            ...
                            <el-col style="margin-left:-70%;width:50%;overflow:hidden">
                                <el-row>
                                    <div style="font-size:16px; font-weight:bold" class="hover-cursor"
                                         @click="jumpToUser(followUser.id)">{{followUser.username}}
                                    </div>
                                </el-row>
                                <el-row>
              ...
              <span>
                ...
                <span @click="jumpToUser(moment.forwardFromUserId)"
                  ...
                  @{{moment.forwardFromUserName}}</span>
                        ...
                        <el-row>
                            <img :src="moment.likeImg" alt="bottomlike" @click="likeHandler(moment)" height="30px"
                                 width="30px" style="margin-left:2%">
                            <img :src="moment.collectImg" alt="collect" @click="collectHandler(moment)" height="30px"
                                 width="30px" style="margin-left:2%">
                            <img src="../image/forward.png" alt="forward" @click="forwardHandler(moment)" height="30px"
                                 width="30px" style="margin-left:2%">
                            <img src="../image/user-more.png" alt="more" @click="userMoreHandler(moment)" height="30px"
                                 width="30px" style="margin-right:2%;float:right">
                        </el-row>
                        ...
                        <el-col style="padding:5px 15px">
                            ...
                            <!-- tag -->
                            <el-row>
                                <span class="hover-cursor tag" @click="jumpToTag(tag)"
                                      v-for="(tag,index) in moment.tags" :key="index">#{{tag}}</span>
                            </el-row>
                            <!-- comments -->
        ...
        <!-- 更多操作 -->
        <el-dialog title="更多" :center="true" :visible.sync="usermoreDialogVisible" width="20%" :show-close="false"
                   top="15%">
            <el-row>
                <div style="border-top:1px solid rgb(235,238,245)"></div>
                <div @click="jumpToDetail(usermoreMomentId)" style="text-align:center;margin:10px 0;letter-spacing:1px"
                     class="hover-cursor">查看动态
                </div>
                <div style="border-top:1px solid rgb(235,238,245)"></div>
            </el-row>
        </el-dialog>
